...
import static com.alphamedia.rutilahu.R.drawable.above_shadow;
import static com.alphamedia.rutilahu.R.drawable.below_shadow;
...
public class SlidingUpPanelLayout extends ViewGroup {
    ...
    public SlidingUpPanelLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (mShadowHeight > 0) {
            if (mIsSlidingUp) {
                mShadowDrawable = getResources().getDrawable(above_shadow);
            } else {
                mShadowDrawable = getResources().getDrawable(below_shadow);
            }
